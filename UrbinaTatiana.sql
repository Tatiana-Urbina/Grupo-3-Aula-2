...
select DNI_Dueno  from Perro where ID_Perro = 2;
...
insert Perro (Nombre, Fecha_nac, Sexo, DNI_Dueno) value ("Yimi", '2022-02-10', "Hembra", 12456987);
...
insert Perro (Nombre, Fecha_nac, Sexo, DNI_Dueno) value ("Gretta", '2020-09-20', "Hembra", 22376258);
...
select Monto from Historial Where Month(Fecha)= 07 and year(Fecha) = 2022 -- PUNTO 7:  Muestra solo los montos/Ingresos del mes de Julio del 2022.-- 
